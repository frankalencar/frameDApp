...
<div class="container">
            ...
            <div class="jumbotron">
                ...
                <div class="row mt-5">
                    <div class="col col-md-8">
                        <button onclick="location.href = '/frameworkDApp/visao/frame/06per2simper3per4.php?figura=sim';" type="button" class="btn btn-dark">Sim</button>
                        <button onclick="location.href = '/frameworkDApp/visao/frame/06per2simper3per4.php?figura=nao';" type="button" class="btn btn-dark">Não</button>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col col-md-6">
            <img src="/frameworkDApp/recursos/imagens/per02simper03.png" class="img-fluid" alt="...">
        </div>
        <div class="col col-md-3"></div>
    </div>
    <div class="row">
