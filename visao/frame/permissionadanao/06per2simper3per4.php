...
<div class="container">
    ...
    <div class="row">
        <div class="col col-md-12">
            <button onclick="location.href = '/frameworkDApp/visao/frame/permissionadanao/05per02NaoPer3linguagem.php?figura=<?php echo $_GET['figura'] ?>';" type="button" class="btn btn-primary">Voltar</button>
        </div>
    </div>
</div>
